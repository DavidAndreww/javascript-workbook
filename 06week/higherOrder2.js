...
let arrayOfNums = strNums.map(stringsToNumbs);
// console.log(arrayOfNums);
// console.log(typeof arrayOfNums) //Why does this say they are objects and not numbers?



// // // With the same numbers, find the sum of the even values
// const sumEvens = strNums.filter((nums) => {
//   return nums % 2 === 0;
// });
...
const atxIdx = arrayOfNums.findIndex((val, index) => {
  return val + index == 512;
});

// console.log(`index: ${atxIdx}, value: ${arrayOfNums[atxIdx]}`);
...
input = input.toLowerCase().match(regex)
input.forEach((unique) => (counts[unique] = counts[unique] ? ++counts[unique] : 1))
console.log(counts)
